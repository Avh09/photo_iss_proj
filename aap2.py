...
def save_selected_photos():
    ...
    # Connect to MySQL database
        ...
        return video_base64
    video_base64 = create_video(selected_filenames)
    video_url = url_for('static', filename='output_video2.mp4')
    print("Video URL:", video_url)
    return jsonify({'video_base64': video_base64, 'video_url': video_url})
